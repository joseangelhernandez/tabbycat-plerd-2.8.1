    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seq', models.IntegerField('seq', models.IntegerField(default=0, help_text='A number that determines the relative order in which tournaments are displayed on the homepage.', verbose_name='sequence number'))),
